...
# 兜底产品清单（zhiji 挂 + market.json 空时保证构建不断流；2026-08-20 对齐 8/18 原始 76 品种含 sector/exch）
FALLBACK_PRODUCTS: dict[str, tuple[str, str, str]] = {
    "A": ("豆一", "大商所", "农产品"),
    "AD": ("铸造铝合金", "上期所", "有色"),
    "AG": ("沪银", "上期所", "贵金属"),
    "AL": ("沪铝", "上期所", "有色"),
...
# sina 品种 node 映射（2026-08-20 主用，zhiji 配额耗尽后行情源）
SINA_NODES = {
    # 上期所
